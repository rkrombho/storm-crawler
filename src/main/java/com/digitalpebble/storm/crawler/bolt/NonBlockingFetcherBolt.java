...
public class NonBlockingFetcherBolt extends BaseRichBolt {
    ...
    private DelayQueue<FetchItem> toFetch = null; // TODO init

    /**
     * This class described the item to be fetched.
     */
    private static class FetchItem implements Delayed {
    ...
    private static class FetchItemQueue {
        Deque<FetchItem> queue = new LinkedBlockingDeque<NonBlockingFetcherBolt.FetchItem>();
